...
# Imprimir detalles del nodo de inicio y del nodo obj
# Crear una cuadrícula que incluya los puntos finales
grid = create_grid_inclusive(-2.5, 2.5, -2.5, 2.5, 0.1)
...
path_inclusive = a_star_search_improved(grid, start_coords, goal_coords)
